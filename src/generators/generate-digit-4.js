function generateFourthDigit () {
    const customerHeight = prompt(`Въведете Вашата височина в сантиметри`);
    const customerMass = prompt(`Въведете Вашата маса в килограми`);

    const customerBMI       = customerHeight / (customerMass * customerHeight);
